...
if __name__ == '__main__':
    ...
    parser.add_argument('--summary_filepath', type=str, default='../PPBind-1D_example_data.csv')
    parser.add_argument('--cache_dir', type=str, default='./cache_data/PPBind-1D_example_data/')
    parser.add_argument('--save_dir', type=str, default='./cache_data/PPBind-1D_example_data/pt/')
