...
from rde.datasets import Mixed
import itertools
...
class SkempiDatasetManager(object):
    ...
    def init_loaders(self, fold):
        ...
        train_dataset = dataset_(split='train', transform = get_transform(config.data.transform.train))
        val_dataset = dataset_(split='val', transform = get_transform(config.data.transform.val))
